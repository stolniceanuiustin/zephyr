...
/**
 * @brief JESD204 phase table for the transceiver.
 *
 * Registers axi_adxcvr_enable() as this device's CLOCKS_ENABLE work. A board
 * points one jesd204_dev per direction at this table, each carrying its Zephyr
 * device in `priv`.
 */
extern const struct jesd204_dev_data adxcvr_jesd204_data;
