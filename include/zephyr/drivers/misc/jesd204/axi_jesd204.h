...
/**
 * @brief JESD204 phase table for the link core.
 *
 * Registers axi_jesd204_lane_clk_enable() as CLOCKS_ENABLE and a DATA poll as
 * LINK_RUNNING. Shared by both directions; a board points one jesd204_dev per
 * core at this table with the Zephyr device in `priv`.
 */
extern const struct jesd204_dev_data axi_jesd204_jesd204_data;
