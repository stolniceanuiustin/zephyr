...
/**
 * @brief JESD204 phase table for the AD9144 (TX topology top device).
 *
 * Registers a SERDES PLL re-enable as this converter's CLOCKS_ENABLE work, run
 * after the FPGA TX datapath is armed. A board points its ad9144 jesd204_dev at
 * this table with the Zephyr device in `priv`.
 */
extern const struct jesd204_dev_data ad9144_jesd204_data;
