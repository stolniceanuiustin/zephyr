 ...
 * xilinx_transceiver.c forward-declares (in xilinx_transceiver.h) and holds a pointer
 ...
 * (declared in xilinx_transceiver.h), passing back the struct adxcvr * it was handed.
...
const struct jesd204_dev_data adxcvr_jesd204_data = {
	.max_num_links = 1,
	.state_ops = {
