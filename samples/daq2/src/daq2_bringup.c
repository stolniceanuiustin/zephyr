 ...
 * `priv`. The phase table (adxcvr_jesd204_data) lives in the axi_adxcvr driver;
 * the topology says which instance serves which link.
 */
...
/* Phase table (axi_jesd204_jesd204_data) lives in the axi_jesd204 driver. */
...
/* Phase table (ad9144_jesd204_data) lives in the ad9144 driver. */
...
/* Phase table (ad9680_jesd204_data) lives in the ad9680 driver. */
